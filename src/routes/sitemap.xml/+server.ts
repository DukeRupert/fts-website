...
const pages: string[] = ["about-us", "contact-us", "financing", "jobs", "privacy-policy", "projects", "services", "drainage", "hardscape", "site-preparation"] //list of pages as a string ex. ["about", "blog", "contact"]

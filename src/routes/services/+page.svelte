		...
		>
			<div class="relative pl-9">
				<dt class="inline font-semibold text-gray-900">
					...
					<!-- <span class="text-red-500">{@html data.icon.svg}</span> -->
					{componentData.features[0].title}
				</dt>
				<dd class="inline">
					{componentData.features[0].description}
				</dd>
			</div>
			...
			<div class="relative pl-9">
				<dt class="inline font-semibold text-gray-900">
					<!-- Heroicon name: mini/finger-print -->
					<svg
						class="absolute top-1 left-1 h-5 w-5 text-indigo-600"
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
			...
			<div class="relative pl-9">
				<dt class="inline font-semibold text-gray-900">
					<!-- Heroicon name: mini/cog-6-tooth -->
					<svg
						class="absolute top-1 left-1 h-5 w-5 text-indigo-600"
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"

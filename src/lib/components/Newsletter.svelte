...
<div>
	<div class="mx-auto max-w-7xl py-12 px-6 lg:py-16 lg:px-8">
		<div
			class="rounded-lg bg-gradient-to-r from-primary-400 to-primary-600 px-6 py-6 md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center"
		>
			<div class="xl:w-0 xl:flex-1">
				...
				<p class="mt-3 max-w-3xl text-lg leading-6">
					<span class="text-on-warning-token">Sign up for our newsletter to stay up to date.</span>
				</p>
			</div>
			<div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
				...
				<p class="mt-3 text-sm">
					...
					>
					<a href="/privacy-policy"><span class="text-tertiary-200">Privacy Policy</span>.</a>
				</p>
			</div>
		</div>
	</div>

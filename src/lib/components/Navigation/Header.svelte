	...
	<nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
		<div class="flex items-center gap-x-12">
			...
			<div class="hidden lg:flex lg:gap-x-8">
				...
				<a
					href="/about-us"
					class="unstyled text-sm font-semibold leading-6 text-gray-900 hover:underline">About Us</a
				>
				<a
					href="/projects"
				...
				<a
					href="/contact-us"
					class="unstyled text-sm font-semibold leading-6 text-gray-900 hover:underline"
					>Contact Us</a
				>
			</div>
		</div>

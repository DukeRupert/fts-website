	...
	<div class="relative">
		...
		>
			<div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
				<div>
					<div>
						<span class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600">
					...
					<div class="mt-6">
						...
						<p class="mt-4 text-lg text-gray-500">
							...
							common in the Puget Sound region. We also offer residential and commercial excavating
							services including site preparation, leveling, road work, land clearing and utility
							installation.
						</p>
						<div class="mt-6">
